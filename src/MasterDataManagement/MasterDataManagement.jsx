...
import ViewMode from "../componentss/CustomComponents/ViewMode";
import CatagoryCard from "../componentss/CustomComponents/CatagoryCard";
import ImageGridCard from "../componentss/CustomComponents/ItemGridCard";
...
const MasterItemsGrid = () => {
  ...
  const {setActiveItem,activeItem}=useContext(ParentContext);
  ...
  if (currentScreen === "master"&&selectedMaster ) {
    return <MasterScreen master={selectedMaster} setCurrentScreen={setCurrentScreen} />;
  }
